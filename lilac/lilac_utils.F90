...
!========================================================================
  ...
  subroutine lilac_init_atm2lnd(lsize)
    ...
    call atm2lnd_add_fld (atm2lnd, fldname='Sa_z'       , units='unknown', provided_by_atm=.true., lsize=lsize)
    call atm2lnd_add_fld (atm2lnd, fldname='Sa_topo'    , units='unknown', provided_by_atm=.true., lsize=lsize)
    call atm2lnd_add_fld (atm2lnd, fldname='Sa_u'       , units='unknown', provided_by_atm=.true., lsize=lsize)
    call atm2lnd_add_fld (atm2lnd, fldname='Sa_v'       , units='unknown', provided_by_atm=.true., lsize=lsize)
    call atm2lnd_add_fld (atm2lnd, fldname='Sa_ptem'    , units='unknown', provided_by_atm=.true., lsize=lsize)
    call atm2lnd_add_fld (atm2lnd, fldname='Sa_pbot'    , units='unknown', provided_by_atm=.true., lsize=lsize)
    call atm2lnd_add_fld (atm2lnd, fldname='Sa_tbot'    , units='unknown', provided_by_atm=.true., lsize=lsize)
    call atm2lnd_add_fld (atm2lnd, fldname='Sa_shum'    , units='unknown', provided_by_atm=.true., lsize=lsize)
    call atm2lnd_add_fld (atm2lnd, fldname='Sa_methane' , units='unknown', provided_by_atm=.true., lsize=lsize)
    call atm2lnd_add_fld (atm2lnd, fldname='Faxa_lwdn'  , units='unknown', provided_by_atm=.true., lsize=lsize)
    call atm2lnd_add_fld (atm2lnd, fldname='Faxa_rainc' , units='unknown', provided_by_atm=.true., lsize=lsize)
    call atm2lnd_add_fld (atm2lnd, fldname='Faxa_rainl' , units='unknown', provided_by_atm=.true., lsize=lsize)
    call atm2lnd_add_fld (atm2lnd, fldname='Faxa_snowc' , units='unknown', provided_by_atm=.true., lsize=lsize)
    call atm2lnd_add_fld (atm2lnd, fldname='Faxa_snowl' , units='unknown', provided_by_atm=.true., lsize=lsize)
    call atm2lnd_add_fld (atm2lnd, fldname='Faxa_swndr' , units='unknown', provided_by_atm=.true., lsize=lsize)
    call atm2lnd_add_fld (atm2lnd, fldname='Faxa_swvdr' , units='unknown', provided_by_atm=.true., lsize=lsize)
...
!========================================================================
  ...
  subroutine atm2lnd_add_fld(flds, fldname, units, provided_by_atm, lsize)
